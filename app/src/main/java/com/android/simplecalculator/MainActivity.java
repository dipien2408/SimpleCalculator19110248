...
public class MainActivity extends Activity {
    ...
    public void onFact(View view) { compute(Calculator.Operator.FACT); }
    public void onLog(View view) { compute(Calculator.Operator.LOG); }
    ...
    private void compute(Calculator.Operator operator) {
        ...
        switch (operator) {
            ...
            case FACT:
                result = String.valueOf(
                        mCalculator.factorial(operandOne));
                break;
            case LOG:
                result = String.valueOf(
